...
.card[data-rarity="rare holo wotc"] .card__glare {
...
.card[data-rarity="rare holo wotc"] .card__glare:after {
...
.card[data-rarity="rare holo wotc"] .card__shine {
...
.card[data-rarity="rare holo wotc"][data-subtypes^="stage"] .card__shine,
.card[data-rarity="rare holo"][data-subtypes^="stage"] .card__glare:after,
.card[data-rarity="rare holo wotc"][data-subtypes^="stage"] .card__glare:after {
...
.card[data-rarity="rare holo wotc"][data-subtypes^="supporter"] .card__shine,
.card[data-rarity="rare holo"][data-subtypes^="supporter"] .card__glare:after,
.card[data-rarity="rare holo wotc"][data-subtypes^="supporter"] .card__glare:after {
clip-path: inset(12% 0% 48.2% 9%);
}
...
.card[data-rarity*="reverse trainer"] .card__shine,
.card[data-rarity*="reverse trainer"] .card__shine:after {
...
filter: brightness(.8) contrast(2.95) saturate(.8);
}
