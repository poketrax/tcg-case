<script lang="ts">
	...
	let cardBack = 'https://tcg.pokemon.com/assets/img/global/tcg-card-back-2x.jpg';
	export let cardImg = cardBack;

	let number = cardBack;
	export let holoEffect = 'common';
	export let gallery = false;
	export let showcase = false;
	export let activeCard: Writable<any>;
...
--hyp: ${
	...
	$: {
		holoEffect = holoEffect.toLowerCase();
